...
class AboutsControllerTest < ActionController::TestCase
  ...
  test "should create about" do
    assert_difference('About.count') do
      post :create, about: { content: @about.content, content_title: @about.content_title, image: @about.image, subtitle: @about.subtitle, title: @about.title }
    end
  ...
  test "should update about" do
    patch :update, id: @about, about: { content: @about.content, content_title: @about.content_title, image: @about.image, subtitle: @about.subtitle, title: @about.title }
    assert_redirected_to about_path(assigns(:about))
  end
